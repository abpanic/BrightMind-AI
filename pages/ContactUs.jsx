...
import { FaEnvelope } from 'react-icons/fa'; // Import the email icon from react-icons
...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row items-center justify-center bg-transparent p-6">
      ...
      <div className="lg:w-1/3 lg:ml-8 mt-8 lg:mt-0 bg-transparent flex flex-col items-center justify-center">
