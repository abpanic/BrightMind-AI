  ...
  return (
    <div className={styles.carouselContainer}>
      ...
      <div className={styles.imagesContainer}>
        ...
        >
          <Image className={styles.first} alt="first image" src={imageOne} />
        </motion.div>
        <motion.div
        ...
        >
          <Image className={styles.second} alt="second image" src={imageTwo} />
        </motion.div>
        <motion.div
        ...
        >
          <Image className={styles.third} alt="third image" src={imageThree} />
        </motion.div>
        <div className={styles.controls}>
          ...
          <button
            className={
              activeIndex !== 2 ? `${styles.nextContainer}` : `${styles.disabled}`
            }
            onClick={handleNext}
          >
            <Image
